    ...
    return (
            ...
            <Paper className="container" style={{marginTop: "150px"}}>
                <Grid container spacing={3}>
                    ...
                    {Object.keys(thong.total).length !== 0 ? <>
                    <Grid item xs={6} sm={3}>
                        <Paper className={classes.paper} elevation={3} style={{margin: "30px auto", borderRadius: "10%", backgroundColor: "#8bc34a"}}>
                            <div style={{margin: "20px auto"}}>
                                ...
                                {thong.auction.data.emotions && thong.noAuction.data.emotions ? <h2 className={classes.tong}>{thong.auction.data.emotions?.length + thong.noAuction.data.emotions?.length} emtions</h2>: ""}
                    ...
                    <Paper className={classes.paper} elevation={3} style={{margin: "30px auto", borderRadius: "10%", backgroundColor: "#f4433691"}}>
                            <div style={{margin: "20px auto"}}>
                                ...
                                {thong.auction.data.comment && thong.noAuction.data.comment ? <h2 className={classes.tong}>{thong.auction.data.comment?.length + thong.noAuction.data.comment?.length} comments</h2>: ""}

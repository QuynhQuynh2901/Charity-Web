...
const Register = () => {
    ...
    const handleSubmit = async (event) => {
        if (confirm !== profile.password) {
            ...
            try {
                let res = await callApi('api/accounts/', 'POST', formData, header)
                ...
                <div className="container" style={{ width: "50%" }}>
                    ...
                    <div style={{ width: "100%", padding: "30px ", backgroundColor: "#544f4f6b", borderRadius: "30px" }}>
                        ...
                        <div style={{ margin: "10px auto", width: "40%" }}>
                            <button className="btn btn-style btn-primary ml-lg-3 mr-lg-2" style={{ width: "100%" }} onClick={handleSubmit}>Register</button>
                        </div>
                    </div>
                </div>
